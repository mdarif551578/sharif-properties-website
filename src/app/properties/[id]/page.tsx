...
export default function PropertyDetailPage({
  ...
  const propertyJsonLd = {
    ...
    "geo": {
      ...
      "@type": "GeoCoordinates",
      "latitude": "23.7854", // Placeholder
      "longitude": "90.3980"  // Placeholder
    }
  };
  ...
  return (
    <>
      <Head>
        <title>{`${property.title} | Sharif Properties`}</title>
        <meta name="description" content={`Details for ${property.title}, a premium ${property.type.toLowerCase()} in ${property.address}, ${property.city}. View images, features, and contact the agent.`} />
        <meta property="og:title" content={`${property.title} | Sharif Properties`} />
        ...
        <meta property="og:url" content={`https://www.sharifproperties.com/properties/${property.id}`} />
